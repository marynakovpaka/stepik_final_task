...
class LoginPageLocators ():
    ...
    EMAIL_ADDRESS_FIELD_IN_REGISTRATION_FORM = (By.CSS_SELECTOR, "#id_registration-email")
    PASSWORD_FIELD_IN_REGISTRATION_FORM = (By.CSS_SELECTOR, "#id_registration-password1")
    CONFIRM_PASSWORD_FIELD_IN_REGISTRATION_FORM = (By.CSS_SELECTOR, "#id_registration-password2")
